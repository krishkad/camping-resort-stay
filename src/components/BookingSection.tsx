...
const BookingSection = () => {
  ...
  const accommodationOptions = [
    {
      value: "safari-dome",
      label: "Luxury Safari Dome - $350/night",
      price: 350,
    },
    {
      value: "forest-cabin",
      label: "Forest Cabin Retreat - $450/night",
      price: 450,
    },
    {
      value: "riverside-tent",
      label: "Riverside Safari Tent - $280/night",
      price: 280,
    },
    {
      value: "mountain-lodge",
      label: "Mountain View Lodge - $520/night",
      price: 520,
    },
  ];
  ...
  const calculateTotal = () => {
    ...
    const accommodation = accommodationOptions.find(
      (acc) => acc.value === selectedAccommodation,
    );
  ...
  return (
    <section
      id="booking"
      className="py-20 bg-gradient-to-br from-[var(--forest-50)] to-[var(--earth-50)]"
    >
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div
            className="bg-white rounded-3xl overflow-hidden shadow-[0_0_20px_5px_rgba(139,115,85,0.5)] 
              ...
              {currentStep === 3 && (
                <div className="space-y-8 animate-fade-in">
                  ...
                  <div className="bg-forest-50 rounded-2xl p-6 space-y-4">
                    <h4 className="font-playfair text-xl font-semibold text-[var(--forest-700)]">
                      Booking Summary
                    </h4>
