...
const CampListings = () => {
  ...
  const accommodations = [
    {
      ...
      category: "dome",
      images: ["/images/accommodation/tent-tent.jpg"],
      price: 3500,
      guests: 2,
      amenities: [
        "Private Bathroom",
    ...
    },
    {
      ...
      category: "cabin",
      images: ["/images/accommodation/triangle-tent.jpg"],
      price: 4500,
      guests: 4,
    ...
    },
    {
      ...
      category: "tent",
      images: ["/images/accommodation/triangle-tent-2.jpeg"],
      price: 2800,
      guests: 2,
  ...
  return (
    <section
      id="accommodations"
      className="py-20 bg-gradient-to-b from-[var(--cream-100)] to-white"
    >
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-[var(--forest-600)] max-w-2xl mx-auto">
            Choose your perfect retreat from our collection of premium
