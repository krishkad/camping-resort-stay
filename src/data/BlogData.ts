...
export const blogPosts: BlogPost[] = [
  {
    ...
    tableOfContents: [
      ...
      { id: "pawana-lake", title: "1. Pune Camps - The Crown Jewel", level: 2 },
    ...
    seo: {
      ...
      metaDescription: "Discover 7 secret camping spots near Pune perfect for weekend getaways. From Pune Camps to hidden valleys, find your perfect camping adventure in Maharashtra.",
    ...
    content: `
      <div class="blog-content">
        ...
        <h2 id="pawana-lake">1. Pune Camps - The Crown Jewel of Camping Near Pune</h2>
        ...
        <p>Nestled between Lonavala and Khandala, Pune Camps offers the perfect blend of adventure and comfort. This artificial reservoir, created by the Pawana Dam, transforms into a camping paradise during the cooler months.</p>
        ...
        <ul>
          <li>Sunrise views over Pune Camps</li>
  ...
  },
  {
    ...
    content: `
      <div class="blog-content">
        ...
        <h3>1. Pune Camps (110 km - 2.5 hours)</h3>
  ...
  },
  {
    ...
    content: `
      <div class="blog-content">
        ...
        <ul>
          <li>Pune Camps - Luxury camping with facilities</li>
  ...
  },
  {
    ...
    content: `
      <div class="blog-content">
        ...
        <h3>1. Pune Camps - The Ultimate Romantic Paradise</h3>
        ...
        <p>Pune Camps stands as the crown jewel of romantic camping near Pune. The serene waters reflect the surrounding hills, creating a mirror-like surface that's perfect for romantic boat rides at sunset.</p>
        ...
        <ul>
          <li>Sunrise at Pune Camps with mountain backdrop</li>
  ...
  },
  {
    ...
    content: `
      <div class="blog-content">
        ...
        <p><strong>Best Locations:</strong> Pune Camps, Mulshi Dam, Kolad River<br>
        ...
        <ul>
          ...
          <li>Highlights: Triangular fort, Pune Camps views</li>
        ...
        <ul>
          <li>Pune Camps circuit (Easy - 10 km)</li>
        ...
        <ul>
          ...
          <li>Pune Camps circuit walk (2 hours)</li>
